  ...
  <Row>
    ...
    <Modal v-model="modalAdd" title="用户添加" width="730"
      ...
      <Form :model="user" ref="formValidate" :label-width="80" :rules="ruleValidate">
        <Row :gutter="60">
          <i-col span="18">
            <Form-item label="手机号" prop="realName">
              <Input v-model="user.phone" @on-enter="handleSubmit('formValidate')" placeholder="请输入"></Input>
            </Form-item>
          </i-col>
          <i-col span="6">
            <Button type="info" shape="circle" icon="search">查询</Button>
          </i-col>
        </Row>

        <Row :gutter="60">
          <i-col span="18">
            <Form-item label="昵称" prop="realName">李经理</Form-item>
          </i-col>
        </Row>
        <Row :gutter="60">
          <i-col span="18">
            <Form-item label="用户ID" prop="realName">201703031</Form-item>
          </i-col>
        </Row>

        <Row :gutter="60">
          <i-col span="18">
            <Form-item label="注册时间" prop="realName">2017-09-09</Form-item>
          </i-col>
        </Row>
        <Row :gutter="60">
          <i-col span="18">
            <Form-item label="选择机构" prop="realName">
              <Row>
                <iCol span="24">
                  <Select v-model="user.phone" placeholder="请选择机构">
                    <Option value="beijing">宜信</Option>
                    <Option value="shanghai">广大</Option>
                    <Option value="shenzhen">广发</Option>
                    <Option value="shenzhen">个人理财师</Option>
                  </Select>
                </iCol>
              </Row>
            </Form-item>
...
//                      this.modalManager = true;
                      this.$router.push({path: 'fbDetail'});
                    }
                  }
                }, '详情')
              ]);
